(function () {
  window.CarryDifferentialEquations.register({
    ...
    intro: ["A system tracks several changing quantities at once.", "For <math>mathbf{x}'=Amathbf{x}</math>, eigenvalues and eigenvectors organize the motion.", "A phase portrait shows trajectories in state space rather than against time."],
    overview: {
      workedRows: [
    ...
    problems: [
      ...
      { prompt: "For <math>mathbf{x}'=Amathbf{x}</math>, what matrix determines the linear dynamics?", answer: "A", hint: "It multiplies the state vector.", label: "system matrix", choices: [{ value: "A", label: "A" }, { value: "x", label: "x" }] },
