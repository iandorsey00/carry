...
- `courses/differential-equations/workspaces/guided-derivation.js` provides the reusable staged-equation engine; method-specific workspace files supply equations, accepted forms, and hints.
